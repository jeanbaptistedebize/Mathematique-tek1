...
test_fonc()
{
    ./107transfer "0*0*9" "1*3*5" "2*4*6" "8*8*8" > file1.test
    test_check_diff  file1.test tests/file_test/ex_1
    nbr_tests=$(($nbr_tests + 1))
    ./107transfer "0*1*2*3*4" "1" > file2.test
    test_check_diff  file2.test tests/file_test/ex_2
    nbr_tests=$(($nbr_tests + 1))
}
